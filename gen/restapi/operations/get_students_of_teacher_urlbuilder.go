...
func (o *GetStudentsOfTeacherURL) WithBasePath(bp string) *GetStudentsOfTeacherURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetStudentsOfTeacherURL) Build() (*url.URL, error) {
	...
	var _path = "/teacher/{ID}/students"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{ID}", id, -1)
	} else {
		return nil, errors.New("id is required on GetStudentsOfTeacherURL")
	}
...
func (o *GetStudentsOfTeacherURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetStudentsOfTeacherURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetStudentsOfTeacherURL")
	}
