...
func (fn GetSubjectsOfStudentHandlerFunc) Handle(params GetSubjectsOfStudentParams) middleware.Responder {
	return fn(params)
}
...
func NewGetSubjectsOfStudent(ctx *middleware.Context, handler GetSubjectsOfStudentHandler) *GetSubjectsOfStudent {
	return &GetSubjectsOfStudent{Context: ctx, Handler: handler}
}
...
func (o *GetSubjectsOfStudent) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetSubjectsOfStudentParams()
