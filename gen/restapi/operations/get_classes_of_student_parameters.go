...
// GetClassesOfStudentParams contains all the bound params for the get classes of student operation
...
func (o *GetClassesOfStudentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetClassesOfStudentParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
