...
func (o *GetClassesOfStudentURL) WithBasePath(bp string) *GetClassesOfStudentURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetClassesOfStudentURL) Build() (*url.URL, error) {
	...
	var _path = "/student/{ID}/classes"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{ID}", id, -1)
	} else {
		return nil, errors.New("id is required on GetClassesOfStudentURL")
	}
...
func (o *GetClassesOfStudentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetClassesOfStudentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetClassesOfStudentURL")
	}
