...
func (o *AssignSubjectToStudentURL) WithBasePath(bp string) *AssignSubjectToStudentURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *AssignSubjectToStudentURL) Build() (*url.URL, error) {
	...
	var _path = "/student/{ID}/subject"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{ID}", id, -1)
	} else {
		return nil, errors.New("id is required on AssignSubjectToStudentURL")
	}
...
func (o *AssignSubjectToStudentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AssignSubjectToStudentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AssignSubjectToStudentURL")
	}
