...
// UpdateTeacherNameParams contains all the bound params for the update teacher name operation
...
func (o *UpdateTeacherNameParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body UpdateTeacherNameBody
...
func (o *UpdateTeacherNameParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
