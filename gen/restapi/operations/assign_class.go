...
func (fn AssignClassHandlerFunc) Handle(params AssignClassParams) middleware.Responder {
	return fn(params)
}
...
func NewAssignClass(ctx *middleware.Context, handler AssignClassHandler) *AssignClass {
	return &AssignClass{Context: ctx, Handler: handler}
}
...
func (o *AssignClass) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewAssignClassParams()
