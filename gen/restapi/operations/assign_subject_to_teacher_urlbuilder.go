...
func (o *AssignSubjectToTeacherURL) WithBasePath(bp string) *AssignSubjectToTeacherURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *AssignSubjectToTeacherURL) Build() (*url.URL, error) {
	...
	var _path = "/teacher/{ID}/subject"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{ID}", id, -1)
	} else {
		return nil, errors.New("id is required on AssignSubjectToTeacherURL")
	}
...
func (o *AssignSubjectToTeacherURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on AssignSubjectToTeacherURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on AssignSubjectToTeacherURL")
	}
