...
// GetTeachersOfClassParams contains all the bound params for the get teachers of class operation
...
func (o *GetTeachersOfClassParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTeachersOfClassParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
