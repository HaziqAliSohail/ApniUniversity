...
// GetDefaultedStudentAccountsParams contains all the bound params for the get defaulted student accounts operation
...
func (o *GetDefaultedStudentAccountsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
