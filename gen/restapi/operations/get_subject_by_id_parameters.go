...
// GetSubjectByIDParams contains all the bound params for the get subject by ID operation
...
func (o *GetSubjectByIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
