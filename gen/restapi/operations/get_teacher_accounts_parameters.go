...
// GetTeacherAccountsParams contains all the bound params for the get teacher accounts operation
...
func (o *GetTeacherAccountsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
