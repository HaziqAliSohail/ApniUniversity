...
// GetSubjectsOfStudentParams contains all the bound params for the get subjects of student operation
...
func (o *GetSubjectsOfStudentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetSubjectsOfStudentParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
