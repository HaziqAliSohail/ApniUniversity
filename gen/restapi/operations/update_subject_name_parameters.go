...
// UpdateSubjectNameParams contains all the bound params for the update subject name operation
...
func (o *UpdateSubjectNameParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body UpdateSubjectNameBody
...
func (o *UpdateSubjectNameParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
