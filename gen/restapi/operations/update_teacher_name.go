...
func (fn UpdateTeacherNameHandlerFunc) Handle(params UpdateTeacherNameParams) middleware.Responder {
	return fn(params)
}
...
func NewUpdateTeacherName(ctx *middleware.Context, handler UpdateTeacherNameHandler) *UpdateTeacherName {
	return &UpdateTeacherName{Context: ctx, Handler: handler}
}
...
func (o *UpdateTeacherName) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewUpdateTeacherNameParams()
