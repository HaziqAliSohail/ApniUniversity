...
func (o *GetSubjectsOfStudentURL) WithBasePath(bp string) *GetSubjectsOfStudentURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetSubjectsOfStudentURL) Build() (*url.URL, error) {
	...
	var _path = "/student/{ID}/subjects"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{ID}", id, -1)
	} else {
		return nil, errors.New("id is required on GetSubjectsOfStudentURL")
	}
...
func (o *GetSubjectsOfStudentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetSubjectsOfStudentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetSubjectsOfStudentURL")
	}
